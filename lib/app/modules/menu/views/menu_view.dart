...
//                       mainAxisAlignment: MainAxisAlignment.start,
//                       children: [
//                         // ---------- NON-VEG FILTER BUTTON (COMMENTED) ----------
//                         /*
//                         GestureDetector(
//                           onTap: () {
//                             menuController.getItemVgDataList(
//                                 10,
//                                 menuController
//                                     .categoryDataList[menuController.currentIndex]
//                                     .slug!);
//                           },
//                           child: Container(
//                             decoration: BoxDecoration(
...
//                           child: Text(
//                             menuController.fromHome
//                                 ? menuController.categoryDataList[categoryId].name!
//                                 : menuController
//                                 .categoryDataList[menuController.selectedCategoryIndex]
//                                 .name!,
//                             style: fontBoldWithColor,
//                             overflow: TextOverflow.ellipsis,
//                             maxLines: 1,
        ...
        child: Stack(
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // ---------- VEG/NON-VEG FILTER SECTION (COMMENTED OUT) ----------
                  /*
                  Padding(
                    padding: EdgeInsets.only(top: 24.h, bottom: 24.h),
                    child: Row(
                  ...
                  */
                  // ---------- END VEG/NON-VEG FILTER SECTION ----------
